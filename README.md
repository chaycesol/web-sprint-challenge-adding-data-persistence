...
A database is what holds your data - SQL is what can manipulate views, update, edit, add, or delete data from your database

2. Why do tables need a `primary key`?
Each record needs a unique id that they can reference to in order to relate data from one table to another
...
You need something called a 'join' table, which you can use as a way to match items between two tables
